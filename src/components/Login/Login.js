    ...
    return (
        <div className='login'>
            <div className="bg-white shadow text-center login-item rounded mt-3 mx-auto position-absolute top-50 start-50 translate-middle">
                ...
                <form className='mt-5'>
                <input type="text" placeholder='Email' className='form-control d-inline-block w-100 my-3 border-0 border-bottom text-muted' />
               ...
               <Button className='btn-submit mt-4 w-100'>
                ...
                <p className='mt-5'>Don't have an account? 
                    <Link className='fw-bold'> Sign Up</Link>
                </p>
            </div>
        </div>
    );
