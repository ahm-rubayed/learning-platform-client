    ...
    <div ref={componenetRef} className="container mx-auto my-5 pt-5 w-75">
      <Card>
        <Card.Header className="d-flex justify-content-between align-items-center">
          ...
          <Button onClick={handlePrint} className="btn-submit" title="Print the file"><FaFilePdf/></Button>
        </Card.Header>
        <Card.Img
          variant="top"
        ...
        <Card.Body>
          ...
          <Button className="btn-submit">
            <Link to={`/checkout/${courses_id}`} className="text-white text-decoration-none">Enroll Course</Link>
          </Button>
        </Card.Body>
      </Card>
    </div>
